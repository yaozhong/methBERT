"""
Yao-zhong Zhang @ IMSUT
Tailaring the basic BERT NN to pay more attention to the centric positions.
"""
...
class MultiHeadedAttention_relative(nn.Module):
	def __init__(self, h, d_model, dropout=0.1):
		...
		self.r_v = Relative_PositionalEmbedding(self.d_k, 3)(21)
		self.r_k = Relative_PositionalEmbedding(self.d_k, 3)(21)
...
class BERT_plus(nn.Module):
	def __init__(self, vocab_size=4, hidden=100, n_layers=3, attn_heads=1, dropout=0, motif_shift=0, motif_len=2, inLineEmbed=True, device="cuda:0"):
		super().__init__()
