# basic BERT model
# Based on BERT-pytorch(https://github.com/codertimo/BERT-pytorch)
...
class BERTEmbedding(nn.Module):
	def __init__(self, vocab_size, embed_size, dropout=0, inLineEmbed=True):
		super().__init__()
...
class BERT(nn.Module):
	...
	def __init__(self, vocab_size=4, hidden=32, n_layers=3, attn_heads=1, dropout=0, inLineEmbed=True):
		super().__init__()
	...
	def forward(self, x, segment_info=None):
		...
		x = self.linear(x[:, int(x.size(1)/2), :]) 
